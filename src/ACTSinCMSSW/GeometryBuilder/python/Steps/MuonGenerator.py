...
# with command line options: SingleMuPt100_Eta2p85_cfi -s GEN,SIM -n 100 --conditions auto:phase1_2023_realistic --beamspot DBrealistic --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry DB:Extended --era Run3_2023 --relval 9000,100 --fileout file:step1.root
...
process.generator = cms.EDFilter("Pythia8EGun",
    PGunParameters = cms.PSet(
        ...
        MinEta = cms.double(-1),           # -2.5    
        MaxEta = cms.double(1),            # 2.5
