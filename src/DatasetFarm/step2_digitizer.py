...
# with command line options: step2 -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2023 --conditions auto:phase1_2023_realistic --datatier GEN-SIM-DIGI-RAW -n 100 --eventcontent FEVTDEBUGHLT --geometry DB:Extended --era Run3_2023 --no_exec --filein file:step1.root --fileout file:step2.root
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://eosuser.cern.ch/' + globalPath + filename_input),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('root://eosuser.cern.ch/' + globalPath + filename_output),
