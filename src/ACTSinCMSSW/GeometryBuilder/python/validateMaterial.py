...
# The file records
fileRecords = [
    FileRecord("/eos/user/l/ldamenti/G4MaterialFiles/MaterialFile_ExtendedGeo2023_10000_100_test_TrkOnly.root", "material-tracks", "Geant4", "blue", 3),
    FileRecord("Acts_MatTracks_forValidation.root", "material-tracks", "Acts", "orange", 4),
]


# The plot records
plotRecords = [
    PlotRecord("v_eta", "t_X0", (-4.0, 4.0), 80, "η", "tX0_vs_eta_New.svg"),
    PlotRecord("v_phi", "t_X0", (-math.pi, math.pi), 72, "φ", "tX0_vs_phi_New.svg"),
]
...
for pr in plotRecords:
    ...
    for ifr, fr in enumerate(fileRecords):
        ...
        #print("[DEBUG]", x_arr[:10])
        #if(fr.name == "Acts_MatTracks.root"): 
        #    y_arr = y_arr + 320
