...
process.simToRecoHits = cms.EDProducer("SimToRecoHitProducer",
    # TrackingParticles dal mix
    trackingParticles = cms.InputTag("mix", "MergedTrackTruth"),

    # DigiSimLink (Pixel e Strip)
    pixelDigiSimLink = cms.InputTag("simSiPixelDigis"),
    stripDigiSimLink = cms.InputTag("simSiStripDigis"),

    # RecoHits
    recoHits = cms.InputTag("siPixelRecHits")  # o una collezione merged Pixel+Strip
)
