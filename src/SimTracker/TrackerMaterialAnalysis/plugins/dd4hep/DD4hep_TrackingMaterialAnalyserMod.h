#ifndef DD4hep_TrackingMaterialAnalyserMod_h
#define DD4hep_TrackingMaterialAnalyserMod_h
#include <string>
#include <vector>
...
class DD4hep_TrackingMaterialAnalyserMod : public edm::one::EDAnalyzer<> {
public:
  explicit DD4hep_TrackingMaterialAnalyserMod(const edm::ParameterSet &);
  ~DD4hep_TrackingMaterialAnalyserMod() override;
...
#endif  // DD4hep_TrackingMaterialAnalyserMod_h
