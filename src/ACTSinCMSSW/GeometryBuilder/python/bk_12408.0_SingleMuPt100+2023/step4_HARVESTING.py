...
# with command line options: step4 -s HARVESTING:@standardValidationNoHLT+@standardDQMFakeHLT+@miniAODValidation+@miniAODDQM+@nanoAODDQM --conditions auto:phase1_2023_realistic --mc --geometry DB:Extended --scenario pp --filetype DQM --era Run3_2023 -n 100 --no_exec --filein file:step3_inDQM.root --fileout file:step4.root
...
process.source = cms.Source("DQMRootSource",
    fileNames = cms.untracked.vstring('file:step3_RAW2DIGI_L1Reco_RECO_RECOSIM_VALIDATION_DQM.root')
)
