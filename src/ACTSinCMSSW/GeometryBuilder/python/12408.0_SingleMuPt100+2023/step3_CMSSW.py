...
# ====== Track Selector by Association ======
process.trackSelector = cms.EDProducer("TrackSelectorByAssoc",
...
process.CMSSWTrackingMonitor = process.TrackMon.clone(
    allTrackProducer = cms.InputTag("TrackRefitter"),
...
process.MyTrackingPath = cms.EndPath(process.CMSSWTrackingMonitor)
