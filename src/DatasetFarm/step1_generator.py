...
# with command line options: SingleMuPt100_Eta2p85_cfi -s GEN,SIM -n 100 --conditions auto:phase1_2023_realistic --beamspot DBrealistic --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry DB:Extended --era Run3_2023 --relval 9000,100 --no_exec --fileout file:step1.root
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(nParticles),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('SingleMuPt100_Eta2p85_cfi nevts:100'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('root://eosuser.cern.ch/' + globalPath + filename),
...
process.generator = cms.EDFilter("Pythia8EGun",
    PGunParameters = cms.PSet(
        AddAntiParticle = cms.bool(AddAntiP),     
        MinEta = cms.double(EtaRange[0]),             
        MaxEta = cms.double(EtaRange[1]),           
        MinPhi = cms.double(PhiRange[0]),
        MaxPhi = cms.double(PhiRange[1]),
        MinE = cms.double(energy),               
        MaxE = cms.double(energy),
        # MaxPt  = cms.double(100.0),           
        # MinPt  = cms.double(100.0),           
        ParticleID = cms.vint32(pID)           
    ),
    PythiaParameters = cms.PSet(
